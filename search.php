        ...
        <div class="container">       
          <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
              ...
              <p class="text-white link-nav"><a href="index.php">Home </a> / Search</p>
            </div>  
          </div>
        </div>
      </section>
                  ...
                  ?>
                            <div class="single-post row">
                                <div class="col-lg-3  col-md-3 meta-details">
                                    <ul class="tags mb-3">
                                        <li><a href="post-category.php?cateid=<?php echo $categoryid; ?>">#<?php echo $catename; ?></a></li>
                                    </ul>
                                ...
                                <div class="col-lg-9 col-md-9 ">
                                    <div class="feature-img">
                                        <img class="img-fluid shadow"style="height: 330px;padding: 4px;background: #fff" src="author/adminuploads/<?php echo $row["headerpic"]; ?>" alt="">
                                    </div>
                                   <h3 class="posts-title mt-3"><?php echo $row['headline']; ?></h3>
                                    <p class="excert mt-1">
                                        <?php echo $row['quotes']; ?>
                                    </p>
                                    <a href="blog-single.php?post_id=<?php echo $row["post_id"]; ?>" class="primary-btn">View More</a>
                                </div>
                            </div>
                            <?php
                             }
