...
$search=$_POST['q'];
$query="SELECT * FROM tbl_post WHERE description LIKE'%$search%' OR quotes LIKE'%$search%' OR headline LIKE'%$search%'";
...
?>
<!-- start banner Area -->
      <section class="relative" style="background: url(img/portfolio_bg.png); background-size: cover;">  
        ...
        <div class="container">       
          <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
              ...
              <p class="text-white link-nav"><a href="userindex.php">Home </a> / Search</p>
            </div>  
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 posts-list">
               <p class="mt-5 text-dark" style="font-size: 35px;margin-bottom: 50px;font-weight: 400"> Showing result: "<?php echo $search?>"</p>
              <?php
                ...
                { 
                  ...
                  ?>
                            <div class="single-post row">
                                <div class="col-lg-3  col-md-3 meta-details">
                                    ...
                                    <div class="user-details row">
                                        ...
                                        <p class="comments col-lg-12 col-md-12 col-6">
                                          <a href="user_blog_single.php?post_id=<?php echo $row["post_id"]; ?>">
                                            <?php
                                           if($count>0)
                                           {
                                            ?> 
                                ...
                                <div class="col-lg-9 col-md-9 ">
                                    <div class="feature-img">
                                        <img class="img-fluid shadow"style="height: 330px;padding: 4px;background-color: #fff;" src="author/adminuploads/<?php echo $row["headerpic"]; ?>" alt="">
                                    </div>
                            ...
                            <?php
                              ...
                              ?>
                              <h1 class='text-center mt-5 text-danger'><i class='fa fa-frown-o' style='font-size:33px;'></i> Opps..!</h1><br/> <h3 class='text-center'>No Post Are Available.<p style='font-size: 20px;font-weight: 200'> upload Comming Soon...</p></h3>
                              <?php 
                             }
                            ?>              
               </div>
              ...
              <div class="widget-wrap">
                <div class="single-sidebar-widget search-widget">
                  <form class="search-form" action="user_search.php" method="POST">
                     <input style="outline: none;" required="required" placeholder="Search Posts" name="q" type="text" pattern="^[a-z A-Z]+$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search Posts'" >
                ...
                <div class="single-sidebar-widget user-info-widget">
                  ...
                  <p>
                    Hey everyone, I’m Abhishek and am thrilled to have you visiting my blog.I live in Amroha with my family. I started this blog on a whim in the fall of 2020. I was frequently asked for my article from friends and family members. I happened to follow a few article blogs and one day I thought ” Hey, why not start my own?” So here is the result. My blog is constantly changing and growing as I learn more about blogging. It truly is an art. I hope you enjoy the blog as much as I enjoy creating it.
                  </p>
                </div>
                <div class="single-sidebar-widget popular-post-widget">
                    ...
                    <div class="popular-post-list">
                        ...
                        <div class="single-post-list d-flex flex-row align-items-center">
                            <div class="thumb">
                                <img class="img-fluid shadow" style="width: 90px;height: 55px; padding: 4px;background-color: #fff;" src="author/adminuploads/<?php echo $row2["headerpic"]; ?>" alt="Header pic" >
                            </div>
                            <div class="details">
                   ...
                   <ul class="cat-list">
                     <?php
                       ...
                       { 
                         ...
                         ?>
                       <li>
                           <a href="user_post_category.php?cateid=<?php echo$row3['cate_id'];?>" class="d-flex justify-content-between">
