...
$email=$_SESSION['user'];
$query9="SELECT * FROM tbl_user WHERE email='$email'";
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="userindex.php">Home </a>   / <?php echo $catename; ?></p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="post-content-area single-post-area">
				<div class="container">
							...
							<div class="single-post row">
								<div class="col-lg-12">
									<div class="feature-img">
										<img class="img-fluid shadow" style="height: 430px;padding: 4px;background: #fff;" src="author/adminuploads/<?php echo $headerpic; ?>" alt="Header Pic">
									</div>									
								</div>
								<div class="col-lg-3  col-md-3 meta-details">
									<ul class="tags"><li><a href="user_post_category.php?cateid=<?php echo $categoryid; ?>">#<?php echo $catename; ?></a></li></ul>
                    ...
                    <p class="comments col-lg-12 col-md-12 col-6">
                      <a href="user_blog_single.php?post_id=<?php echo $post_id; ?>">
                        <?php
                          if($count>0)
                          {
                          ?> 
                    ...
                    <div class="col-md-6 col-10 col-sm-10 mb-2">
								...
								<form id="validate_commentform">
									...
									<div class="form-group form-inline">
									  <div class="form-group col-lg-6 col-md-12 name">
									    <input type="text" class="form-control" value="<?php echo$username;?>" name="name" id="name" placeholder="Enter Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'" required="required">
									  </div>
									  <div class="form-group col-lg-6 col-md-12 email">
									    <input type="email" name="email"  value="<?php echo$email;?>"  class="form-control" id="email" placeholder="Enter email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" required="">
									  </div>										
									</div>
       ...
       <div class="comment-form border-0" style="margin-top: -80px">
	    <div class="form-group form-inline">
		 <div class="form-group col-lg-6 col-md-12 name">
		  ...
		  <input type="text" class="form-control" value="<?php echo$username;?>"  id="name" name="name" placeholder="Enter Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Name'" required="required">
		  </div>
		  <div class="form-group col-lg-6 col-md-12 email">
		  <input type="email" id="email" value="<?php echo$email;?>"  name="email" class="form-control"placeholder="Enter email address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" required="">
		  </div>										
		  </div>
		  <div class="form-group text-left">
