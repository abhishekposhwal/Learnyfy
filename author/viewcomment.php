...
$query="SELECT * FROM tbl_comment WHERE post_id='$post_id' ORDER BY comment_id DESC";
        ...
        <div class="col mb-5" style="margin-top: 84px;">
          <div class="card shadow border-0">
            <div class="card-header border-0">
               <div class="row">
                  <div class="col"><h3>Filter Comments</h3></div>
                  <div class="col">
                    <a class="btn btn-dark float-right btn-sm" href="posts.php">Back</a>
                  </div>
                </div>
            </div>
