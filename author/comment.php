        ...
        <div class="col mb-5" style="margin-top: 84px;">
          <div class="card shadow border-0">
            <div class="card-header border-0">
               <h3 class="mb-0 text-dark">All comments</h3>
            </div>
                ...
                <tbody>
                 <?php
                  ...
                  <tr>
                    ...
                    <td><a class="text-dark" href="commentreply.php?comment_id=<?php echo $comment_id?>"><i class="fa fa-reply"></i></a></td>
                    <th scope="row">
                     <a class="btn text-dark btn-sm" href="code/deletecomment.php?comment_id=<?php echo $row['comment_id']; ?>"><i class="fa fa-trash"></i></a>
                    </th>
