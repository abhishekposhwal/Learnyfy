				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a> / Popular Posts</p>
						</div>	
					</div>
				</div>
			</section>
                            ...
                            <div class="single-post row">
                                <div class="col-lg-3  col-md-3 meta-details">
                                    ...
                                    <div class="user-details row">
                                        ...
                                        <p class="comments col-lg-12 col-md-12 col-6"><a href="blog-single.php?post_id=<?php echo $row["post_id"]; ?>">
                                        <?php
                                           if($count>0)
                                           {
                                            ?> 
                   ...
                   <ul class="cat-list">
                     <?php
                      ...
                      { 
                         ...
                         ?>
                       <li>
                           <a href="post-category.php?cateid=<?php echo$cateid;?>" class="d-flex justify-content-between">
