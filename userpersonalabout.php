				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="userindex.php">Home </a>   / About Me</p>
						</div>	
					</div>
				</div>
			</section>
			...
			<section class="home-about-area section-gap">
				<div class="container">
					<div class="row align-items-center justify-content-between">
						<div class="col-lg-6 text-center col-md-6  home-about-left">
							<img class="img-fluid shadow"  src="img/20240513_194106.JPG.jpg" style="height: 350px;padding: 10px; background: #fff;" alt="">
						</div>
            ...
            <div class="text-center">
			  ...
			  <ul>
			    <li>
			      <div class="content">
			        <h4>
			          <time>Diploma in Computer Science</time>
			        </h4>
			    ...
			    <li>
			      <div class="content">
			        ...
			        <p><b>Session:</b> 2014-16</p>
			        <p><b>Result:</b> 83% (In the Scale of 100%)</p>
			      </div>
			    </li>
			  </ul>
			</section>		
