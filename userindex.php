                        ...
                        <div class="col-lg-4 col-md-4 col-9">
                            <div class="single-cat-widget">
                                <div class="content relative">
                                    <div class="overlay overlay-bg"></div>
                                    <a href="user_post_category.php?cateid=<?php echo $cate_id;?>" target="_blank">
                                      <div class="thumb">
                                ...
                                <div class="single-sidebar-widget popular-post-widget">
                                    ...
                                    <div class="popular-post-list">
                                        ...
                                        <div class="single-post-list d-flex align-items-center">
                                            <div class="thumb">
                                                <img style="width:90px;padding: 6px;background: #fff" class="img-fluid shadow"src="author/adminuploads/<?php echo $row2["headerpic"]; ?>" alt="Header pic" >
                                            </div>
                                            <div class="details">
                                ...
                                <div class="single-sidebar-widget post-category-widget">
                                    ...
                                    <ul class="cat-list">
                                        <?php
                                          ...
                                          ?>
                                        <li>
                                            <a href="user_post_category.php?cateid=<?php echo $cate_id;?>" class="d-flex justify-content-between">
