				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<!-- <p class="text-white link-nav"><a href="userindex.php">Home </a>   / <a href="blog-single.php"> Contact</a></p> -->
						</div>	
					</div>
				</div>
		</section>
