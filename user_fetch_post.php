...
elseif ($total_visitor>=1000000 AND $total_visitor<=10000000) {
    ...
    echo '<div class="single-post row"><div class="col-lg-3  col-md-3 meta-details">
                                    <ul class="tags mb-3">
                                        <li><a href="user_post_category.php?cateid='.$categoryid.'">#'.$catename.'</a></li>
                                    </ul>
                                    <div class="user-details row">
                                        ...
                                        <p class="comments col-lg-12 col-md-12 col-6">
                                          <a href="user_blog_single.php?post_id='.$row["post_id"].'">
                                           '.$msg.'
                                ...
                                <div class="col-lg-9 col-md-9 ">
                                   ...
                                   <h3 class="posts-title mt-3">'.$row['headline'].'</h3>
                                    ...
                                    <a href="user_blog_single.php?post_id='. $row["post_id"].'" class="primary-btn">View More</a>
                                </div>
                            </div>';
}
}
